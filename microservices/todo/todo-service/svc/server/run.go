...
func NewEndpoints(service pb.TodoServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		additemEndpoint    = svc.MakeAddItemEndpoint(service)
		deleteitemEndpoint = svc.MakeDeleteItemEndpoint(service)
		listallEndpoint    = svc.MakeListAllEndpoint(service)
	)
